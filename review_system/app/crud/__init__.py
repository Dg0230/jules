...
from .crud_custom_ai_prompt import ( # Add these lines
    create_custom_ai_prompt,
    get_custom_ai_prompt,
    get_custom_ai_prompt_by_review_tag_id,
...
__all__ = [
    ...
    "create_prompt_template", "get_prompt_template", "get_prompt_templates",
    "update_prompt_template", "delete_prompt_template",
    "create_custom_ai_prompt", "get_custom_ai_prompt", # Add these
